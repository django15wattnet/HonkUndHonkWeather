...
JSON_DATA;
    ...
    {
        $this->data = json_decode(self::$jsonData);
    }
    
    
    public function getUrl(ForecastData $forecastData): string
    {
        $wmoCode = $forecastData->weather_code;
        
        if (true === $forecastData->isDay) {
            $dayPart = 'day';
        } else {
            $dayPart = 'night';
        ...
        return $this->data->$wmoCode->$dayPart->image ?? '';
    }
    
    
    public function getDescription(ForecastData $forecastData): string
    {
        $wmoCode = $forecastData->weather_code;
        ...
        return $this->data->$wmoCode->$dayPart->description ?? '';
    }
}
